    ...
    <div className="p-4 d-flex align-items-center justify-content-center">
      <div>
        ...
        <div className="d-flex p-2">
          ...
          <div className="col-3"></div>
          <div className="btn_his">
            <Link to="/rephi">
              <Button variant="outline-success"><i class="bi bi-search"></i> Ver</Button>
            </Link>
          </div>
        </div>
        <div className="d-flex p-2">
          ...
          <div className="btn_his">
            <Link to="/repbank">
              <Button variant="outline-success"><i class="bi bi-cash-coin"></i> Banco</Button>
            </Link>
          </div>
        </div>
      </div>
